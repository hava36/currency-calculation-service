...
public class CurrencyApiController {
    ...
    private final CurrencyConversionService<CurrencyConversionResponse> conversionService;
    ...
    @ApiOperation(value = "convert currency from one to another",
        ...
        response = CurrencyConversionResponse.class, tags = {"users"})
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "currency has been converted successfully", response = CurrencyConversionResponse.class),
